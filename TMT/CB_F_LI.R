...
# 
# 
CB_F_LI <- function(score, age, education_years){
  
  CB_F_LI_db <- data.frame(score = score, age = age, education_years = education_years)
  CB_F_LI_new <- data.frame()
  
  # NSSa
  for (i in 1:nrow(CB_F_LI_db)) {
    res <- CB_F_LI_scale_score(score = CB_F_LI_db[i, "score"], 
                              age = CB_F_LI_db[i, "age"],
                              education_years = CB_F_LI_db[i, "education_years"])
    CB_F_LI_new <- rbind(CB_F_LI_new, res)
  }
  
  return(CB_F_LI_new[,c("CB_F_LI_scale_score", "CB_F_LI_percentil_range", "CB_F_LI_NSSae")])
}

CB_F_LI_scale_score <- function(score, age, education_years) {
