...
db$CB_F_RAW_percentil_range <- with (db, ifelse (
  ...
  db$CB_F_RAW_education_years_adj <- with(db, ifelse(
    is.na(db$CB_F_RAW_scale_score), NA, ifelse (
  ...
  # NSSae
  db$CB_F_RAW_NSSae <- with(db, ifelse(
    is.na(db$CB_F_RAW_education_years_adj), NA, ifelse (
      !is.na(db$CB_F_RAW_education_years_adj), db$CB_F_RAW_scale_score - (0.14886*(db$CB_F_RAW_education_years_adj-12)) )))
