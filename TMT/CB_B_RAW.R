...
db$score >= 11, "> 99" , ifelse (
  ...
  db$CB_B_RAW_education_years_adj <- with(db, ifelse(
    is.na(db$CB_B_RAW_scale_score), NA, ifelse (
  ...
  # NSSae
  db$CB_B_RAW_NSSae <- with(db, ifelse(
    is.na(db$CB_B_RAW_education_years_adj), NA, ifelse (
      !is.na(db$CB_B_RAW_education_years_adj), db$CB_B_RAW_scale_score - (0.20213*(db$CB_B_RAW_education_years_adj-12)) )))
